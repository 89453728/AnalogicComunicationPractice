...
mu=.5;          % constante de modulacion
BT = 2*W;% Ancho de banda de la señal modulada en DBL

% Parámetros del Canal
a = 0.01;       % Atenuación
N0_2 = 1e-8;   % Densidad espectral de potencia del Ruido N0/2
...
xT = A*(1 + mu*m) * sqrt(2).*ptx;                % Señal modulada en AM
...
rL0 = r * sqrt(2).*prx;
rL1 = filtroPasoBajo(t,rL0,WPOS);           % Señal pasada por Hb
rL=supContinua(rL1);                        % supresor de continua
